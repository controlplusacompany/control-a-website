...
const App: React.FC = () => {
  ...
  // FIXED: Explicitly track the window scroll progress
  ...
  const deploySteps = [
    { id: "01", title: "Clarity call", text: "We understand how your business works today and identify exactly what is slowing you down.", visual: <ProcessVisual1 /> },
    { id: "02", title: "System design", text: "We map your ideal processes and decide what to fix, automate, or build first.", visual: <ProcessVisual2 /> },
    { id: "03", title: "Build", text: "We create the automations, workflows, or AI systems needed to handle the work.", visual: <ProcessVisual3 /> },
    { id: "04", title: "Run", text: "Your business operates with less friction, more consistency, and less reliance on memory.", visual: <ProcessVisual4 /> }
  ];

  const capabilities = [
    { title: "Booking flow", description: "Customers book, reschedule, or cancel without back and forth.", visual: <ClockVisual />, theme: "light" },
    { title: "Internal dashboard", description: "A simple view of what is happening today and what needs attention.", visual: <DashboardVisual />, theme: "dark" },
    { title: "Automation logic", description: "Clear rules that decide what happens next so work does not pause.", visual: <AutomationVisual />, theme: "light" },
    { title: "Live status", description: "Check progress at any time without calling or messaging your team.", visual: <LiveStatusVisual />, theme: "dark" },
    { title: "Automated follow ups", description: "Ensure no lead is left behind with smart, timed communication sequences.", visual: <MessageVisual />, theme: "light" },
    { title: "Custom software", description: "Tailored tools built specifically for your unique operational needs.", visual: <AppWindowVisual />, theme: "light" }
  ];
  ...
  // Fix: Added missing gradientColors variable
      ...
      <AnimatePresence mode="wait">
        {view === 'home' ? (
          <motion.div key="home" {...pageTransition} className="pt-24 space-y-12 pb-24">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <motion.div {...fadeIn} className="max-w-3xl mx-auto space-y-8 mb-16">
                      <p className="text-white font-medium text-xl md:text-2xl leading-relaxed">
                        If work only gets done when you personally follow up, your business is doing more manual work than it should.
                      </p>
                      <p className="text-white/60 text-xl md:text-2xl leading-relaxed">
                        We build systems that quietly handle the routine so things run smoothly without constant oversight.
                      </p>
                    </motion.div>
              ...
              <div className="max-w-7xl mx-auto w-full">
                <motion.div {...fadeIn} className="card-3d-white rounded-[64px] p-12 md:p-24 text-center">
                  ...
                  <div className="grid grid-cols-1 gap-6 text-left max-w-2xl mx-auto">
                    {["You chase updates more than you want to", "Tasks slip when someone forgets", "Important work lives in messages and memory", "You feel busy but progress feels slow", "You know systems could help but don't know where to start"].map((text, i) => (
                      <motion.div key={i} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.1 }} className="flex items-center gap-6 p-6 rounded-3xl hover:bg-brand-bg transition-colors border border-transparent hover:border-brand-border">
                ...
                <motion.div {...fadeIn} className="card-3d-white rounded-[64px] p-12 md:p-24">
                  <div className="mb-24 md:text-center">
                    ...
                    <p className="text-xl text-brand-body max-w-3xl mx-auto leading-relaxed font-medium">
                      We design systems that actually get used behind the scenes.
                    </p>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <Card variant="default" title="Automations" description="Workflows that remove repetitive work." icon={<AutomationKeycap />} />
                    <Card variant="default" title="Visibility" description="Dashboards that show exactly what is going on." icon={<DashboardKeycap />} />
                    <Card variant="default" title="Internal Tools" description="Custom software when off-the-shelf isn't enough." icon={<OpsKeycap />} />
                  </div>
                </motion.div>
              </div>
            </section>

            {/* SECTION: RELIABILITY VS TOOLS */}
                ...
                <motion.div {...fadeIn} className="card-3d-green rounded-[64px] p-12 md:p-24 text-center">
                  <div className="mb-20">
                    ...
                    <p className="text-white/80 text-xl max-w-3xl mx-auto leading-relaxed font-medium mb-12">
                      Fewer decisions, fewer hand-offs, and fewer things that rely on memory.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row gap-20 items-center">
                    <div className="flex-1 space-y-10">
                      ...
                      <div className="space-y-8 text-xl text-brand-body leading-relaxed">
                        <p className="font-medium text-brand-muted">We start with how your business actually runs.</p>
                        <ul className="space-y-4 pl-4 border-l-2 border-brand-blue/30">
                          ...
                          <li>Standardize and Automate</li>
                        </ul>
                      </div>
                    </div>
                    <div className="flex-1 w-full flex justify-center">
                       <div className="bg-brand-bg rounded-[56px] p-12 border border-brand-border rotate-3 shadow-2xl max-w-md w-full">
                         ...
                         <div className="flex items-center gap-6">
                            <KeycapIcon label="2" size={56} blueDepth={true} />
                    ...
                    <div className="flex flex-col lg:flex-row gap-20 items-center px-12 py-16 relative z-20">
                      <div className="flex-1 space-y-12">
                        ...
                        <div className="space-y-6">
                          {["Work gets done without reminders", "Clear visibility without asking", "Calm. Predictable. Reliable."].map((text, i) => (
            ...
            <section id="process" className="px-6 md:px-12">
              <div className="max-w-7xl mx-auto w-full">
                <motion.div {...fadeIn} className="card-3d-white rounded-[64px] p-12 md:p-24 overflow-hidden">
                  <h2 className="text-5xl md:text-7xl font-bold text-brand-heading tracking-tighter mb-20 text-center">How we work</h2>
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    {deploySteps.map((step, i) => (
                      <div key={i} className="flex flex-col justify-between h-[400px] rounded-[40px] p-8 transition-all duration-300 hover:-translate-y-2 bg-brand-bg border border-brand-border shadow-elevation relative overflow-hidden">
                         ...
                         <h4 className="text-xl font-bold tracking-tight text-brand-heading mt-4">{step.title}</h4>
                      </div>
                    ))}
                  </div>
                </motion.div>
            ...
            <footer className="py-20 px-6 md:px-12 flex flex-col items-center opacity-50">
              <BrandLogo size={40} />
              <p className="text-brand-muted/30 font-bold text-[11px] uppercase tracking-[0.4em] mt-8">© 2024 Control + A Systems Design</p>
            </footer>
          </motion.div>
        ) : (
